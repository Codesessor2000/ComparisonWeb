...
<head>
  ...
  rel="stylesheet">
  <title>Compare Web:Mobile</title>
...
<div class="navbar navbar-inverse">
  ...
  if (isset($_POST['submit'])) {
    ...
    //Execute query
    $sql = "SELECT * FROM mobile_table WHERE Model LIKE '%$searchinput%' OR Model LIKE '%$searchinput1%' ";
  ...
  ?>
          <tr>
            ...
            <td>
              <?php echo $Battery = $rows['Battery'] ?>
            </td>
            <td>
              <?php echo $Display = $rows['Display'] ?>
            </td>
            <td>
