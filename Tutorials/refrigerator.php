...
<head>
  <meta charset="utf-8">
  <title>Compare Web:Refrigerator</title>
...
<body>
  ...
  if (isset($_POST['submit'])) {
    ...
    //Execute query
    $sql = "SELECT * FROM refrigirator_table WHERE Brand LIKE '%$searchinput%' OR Brand LIKE '%$searchinput1%' ";
  ...
  ?>
          ...
          <tr>
            ...
            <td>
              <?php echo $Capacity_in_Litres = $rows['Capacity_in_Litres'] ?>
            </td>
            <td>
              <?php echo $Doors = $rows['Doors'] ?>
            </td>
            <td>
              <?php echo $Stars = $rows['Stars'] ?>
            </td>
            <td>
              <?php echo $Type_Frezeer = $rows['Type_Frezeer'] ?>
            </td>
            <td>
            ...
            <td>
              <?php $Price_in_Rupees = $rows['Price_in_Rupees'] ?>
            </td>
          </tr>
  ...
  <script>
    ...
    inputBox.onkeyup = (e) => {
      ...
      if (userData) {
        ...
        emptyArray = refirgiratorSuggestions.filter((data) => {
    ...
    inputBox1.onkeyup = (e) => {
      ...
      if (userData1) {
        ...
        emptyArray1 = refirgiratorSuggestions.filter((data) => {
          //filtering array value and user characters to lowercase and return only those words which are start with user enetered chars
