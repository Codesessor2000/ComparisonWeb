...
<div class="navbar navbar-inverse">
  ...
  if (isset($_POST['submit'])) {
    ...
    //Execute query
    $sql = "SELECT * FROM television_table WHERE Model LIKE '%$searchinput%' OR Model LIKE '%$searchinput1%' ";
  ...
  ?>
          ...
          <tr>
            ...
            <td>
              <?php echo $Screen_Size = $rows['Screen Size'] ?>
            </td>
            <td>
              <?php echo $Resolution = $rows['Resolution'] ?>
            </td>
            <td>
              <?php echo $WifiOREthernet = $rows['WifiOREthernet'] ?>
            </td>
            <td>
