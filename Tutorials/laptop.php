...
<head>
  <meta charset="utf-8">
  <title>Compare Web:Laptop</title>
...
<body>
  ...
  if (isset($_POST['submit'])) {
    ...
    //Execute query
    $sql = "SELECT * FROM laptop_table WHERE Model LIKE '%$searchinput%' OR Model LIKE '%$searchinput1%' ";
  ...
  ?>
          <tr>
            ...
            <td>
              <?php echo $RAM = $rows['RAM'] ?>
            </td>
            <td>
              <?php echo $ROM = $rows['ROM'] ?>
            </td>
            <td>
              <?php echo $Processor = $rows['Processor'] ?>
            </td>
            <td>
  ...
  <script>
    ...
    inputBox.onkeyup = (e) => {
      ...
      if (userData) {
        ...
        emptyArray = laptopSuggestions.filter((data) => {
    ...
    inputBox1.onkeyup = (e) => {
      ...
      if (userData1) {
        ...
        emptyArray1 = laptopSuggestions.filter((data) => {
          //filtering array value and user characters to lowercase and return only those words which are start with user enetered chars
